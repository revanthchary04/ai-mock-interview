...
For Firebase Admin, you can either:

- set `FIREBASE_PROJECT_ID`, `FIREBASE_CLIENT_EMAIL`, and `FIREBASE_PRIVATE_KEY`
- or set `FIREBASE_SERVICE_ACCOUNT_KEY` to the full service account JSON as a single string

If you use `FIREBASE_PRIVATE_KEY`, keep the newline characters escaped as `\n` in your `.env` file.
